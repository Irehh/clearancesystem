...
// User section start
    Route::group(['prefix' => '/user', 'middleware' => ['auth', 'user']], function () {
        ...
        // Product
        Route::post('/products', 'UserProductController@store')->name('user.products.store');
        Route::get('/products', 'UserProductController@index')->name('user.products.index');
        Route::get('/products/create', 'UserProductController@create')->name('user.products.create');
        Route::get('/products/{id}/edit', 'UserProductController@edit')->name('user.products.edit');
        Route::put('/products/{id}', 'UserProductController@update')->name('user.products.update');
        Route::delete('/products/{id}', 'UserProductController@destroy')->name('user.products.destroy');
