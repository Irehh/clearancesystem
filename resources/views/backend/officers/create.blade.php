...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('officers.store')}}">
        ...
        <input id="inputfaculty" type="text" name="faculty" placeholder="Enter faculty ID"  value="{{old('faculty')}}" class="form-control">
        @error('faculty')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div>
        <div class="form-group">
          <label for="inputdepartment" class="col-form-label">Department ID</label>
        <input id="inputdepartment" type="text" name="department" placeholder="Enter department ID"  value="{{old('department')}}" class="form-control">
        @error('department')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div>
